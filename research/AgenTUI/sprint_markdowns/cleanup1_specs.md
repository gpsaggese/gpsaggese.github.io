...
- **Codex/Gemini UI**: refer to `codex/codex-rs/tui/src/bottom_pane/chat_composer.rs` for wrap-around navigation & system badge styling; Gemini CLI `packages/cli/src/ui/App.tsx` for explorer wrap behavior.
