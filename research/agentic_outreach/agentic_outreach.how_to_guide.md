...
- The module is located at `ck_marketing/plugins/tracxn`
- Example notebooks are at:
  - `ck_marketing/plugins/tracxn/notebooks/SorrTask601_Extract_VCs_from_Tra_search_mhtml.ipynb`
  - `ck_marketing/plugins/tracxn/notebooks/SorrTask601_Extract_people_from_Tra_company_html.ipynb`
...
- PhantomBuster is an automation tool for extracting and processing web data
  The script provided at `ck_marketing/plugins/linkedin/phantombuster_api.py`
...
- The module is located at
  `ck_marketing/plugins/linkedin/phantombuster_api.py`
...
- The module is located at `ck_marketing/plugins/hunterio/hunterio_api.py`
- Example notebook is at:
  - `ck_marketing/process_automation/Master.cold_outreach.ipynb`
...
- By Company: Use `hunterio_find_emails_from_df` to find email addresses for each row in a
...
- The code is located at `ck_marketing/plugins/dropcontact/drop_contact_api.py`
...
- The module is located at `ck_marketing/plugins/signal_nfx`
- An example notebook is at
  `ck_marketing/plugins/signal_nfx/notebooks/SorrTask612_Get_information_from_Signal.ipynb`
