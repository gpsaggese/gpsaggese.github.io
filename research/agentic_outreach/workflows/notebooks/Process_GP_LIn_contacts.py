...
# # Description
#
# Process GP's LIN connections, by loading the data and enriching it.
...
# normalize = False
normalize = True
contact_df = cmwdlosp.get_data_from_GP_LIn_connections(normalize)
...
contact_df_tmp2 = ckmktpi.merge_hunterio_values(contact_df_tmp)
...
contact_df_tmp3 = ckmktpi.process_email(
    contact_df_tmp2, "first_name", "last_name", "company_name", mode=mode
)
...
ckmktpi.get_is_changed_stats(diagnostics_df)
# -
