...
normalize = True
# normalize = False
url = "https://docs.google.com/spreadsheets/d/1uSS5h5f3bcWxCFxg90TTB46296JgnFGQeKDaIKtz_84/edit?gid=2114845774#gid=2114845774"
tab_name = "results"
tag = "MA_targets_10k_persons"
df_tmp = ckmktwf.get_data_from_SalesNavigator_Search_Results(
...
hpandas.filter_df(debug_df, "is_modified", True).head(100)
