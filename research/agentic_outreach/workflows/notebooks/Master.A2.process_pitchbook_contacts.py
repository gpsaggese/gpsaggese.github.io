...
# tag = "200AI.Corp_dev"
url = "https://docs.google.com/spreadsheets/d/1tXnir8P5VjBxvbQOgJZmArRa7K__J7Fy90rWZtIxXTE/edit?gid=2077123306#gid=2077123306"
tag = "_all_"
tab_name = 
normalize = True
# normalize = False
df_tmp = ckmktwf.get_data_from_pitchbook(
    url, tab_name, timestamp, tag, normalize
)
...
# +
display(contact_df["origin"].value_counts())
