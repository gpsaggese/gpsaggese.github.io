...
class Test_parse_query1(hunitest.TestCase):
    """
    Test parsing LinkedIn Sales Navigator queries into structured format.
    """

    def helper(self, query: str, expected: str) -> None:
        """
        Test helper for parse_query.

        :param query: URL query string to parse.
        :param expected: Expected parsed output.
        """
        # Run test.
        parsed_query = cmplsnaqu.parse_query(query)
        # Check output.
        actual = cmplsnaqu.query_to_str(parsed_query, sort_keys=True)
        self.assert_equal(actual, expected, dedent=True)

    def test1(self) -> None:
        """
        Test parsing query with current job titles and keywords.
        """
        # Prepare inputs.
        query = get_query1()
        # Prepare outputs.
        ...
        """
        # Run test.
        self.helper(query, expected)

    def test2(self) -> None:
        """
        Test parsing query with multiple filters and no keywords.
        """
        # Prepare inputs.
        query = get_query2()
        # Prepare outputs.
    ...
    def test3(self) -> None:
        """
        Test parsing query with company and region filters.
        """
        # Prepare inputs.
        query = get_query3()
        # Prepare outputs.
    ...
    def test4(self) -> None:
        """
        Test parsing query with only company headquarters filter.
        """
        # Prepare inputs.
        query = get_query4()
        # Prepare outputs.
    ...
    def test5(self) -> None:
        """
        Test parsing query with function filter.
        """
        # Prepare inputs.
        query = get_query5()
        # Prepare outputs.
...
class Test_parse_query2(hunitest.TestCase):
    """
    Test round-trip parsing and generation of LinkedIn Sales Navigator queries.
    """

    def helper(self, query: str, mode: str) -> None:
        """
        Test helper for parse_query and generate_query round-trip.

        :param query: URL query string to test.
        :param mode: Assertion mode ('assert_equal' or 'check_string').
        """
        # Run test.
        parsed_query = cmplsnaqu.parse_query(query)
        query_out = cmplsnaqu.generate_query(parsed_query)
    ...
    def test1(self) -> None:
        """
        Test round-trip for query with current job titles and keywords.
        """
        # Prepare inputs.
        query = get_query1()
        # Run test.
    ...
    def test2(self) -> None:
        """
        Test round-trip for query with multiple filters and no keywords.
        """
        # Prepare inputs.
        query = get_query2()
        # Run test.
    ...
    def test3(self) -> None:
        """
        Test round-trip for query with company and region filters.
        """
        # Prepare inputs.
        query = get_query3()
        # Run test.
    ...
    def test4(self) -> None:
        """
        Test round-trip for query with only company headquarters filter.
        """
        # Prepare inputs.
        query = get_query4()
        # Run test.
    ...
    def test5(self) -> None:
        """
        Test round-trip for query with function filter.
        """
        # Prepare inputs.
        query = get_query5()
        # Run test.
    ...
    def test6(self) -> None:
        """
        Test round-trip for complex query with years in position filter.
        """
        # Prepare inputs.
        query = get_query6()
        # Run test.
