...
# Display the JAX and Mctx versions and available accelerator devices.
echo "# JAX and Mctx"
python -c "import jax, mctx; print('jax', jax.__version__); print('mctx', mctx.__version__); print('devices', jax.devices())"
