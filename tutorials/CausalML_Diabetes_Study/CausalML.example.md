...
- [Causal Analysis of Lifestyle Interventions on Diabetes Risk](#causal-analysis-of-lifestyle-interventions-on-diabetes-risk)
  ...
  * [3. Identification Strategy & Assumptions](#3-identification-strategy--assumptions)
  ...
  * [5. Key Findings & Interpretation](#5-key-findings--interpretation)
  ...
  * [6. Robustness & Validation (Advanced Analysis)](#6-robustness--validation-advanced-analysis)
...
3.  **Conservative BMI Control:** I deliberately include BMI as a confounder.
    While BMI is a mediator ($T \to BMI \to Y$), it is also a confounder in
    cross-sectional data (Obesity $\to$ Inactivity). By controlling for it, I
