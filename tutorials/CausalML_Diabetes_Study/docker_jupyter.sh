#!/bin/bash
# """
# Execute Jupyter Notebook in a Docker container.
#
# This script launches a Docker container running Jupyter Notebook with
...
do
    case "${flag}" in
        p) JUPYTER_HOST_PORT=${OPTARG};;  # Port for Jupyter Notebook
