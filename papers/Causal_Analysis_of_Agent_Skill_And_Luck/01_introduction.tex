...
and internal factors (skill) on the right. These pairs reflect different
emphases—philosophical (brute luck vs. earned skill), statistical (noise
vs. signal), or causal (exogenous vs. endogenous)—but all capture the
fundamental dichotomy between controllable and uncontrollable outcome
determinants.
