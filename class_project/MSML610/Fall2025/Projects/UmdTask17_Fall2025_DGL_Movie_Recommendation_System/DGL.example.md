...
After training for **20 epochs**, the bipartite GraphSAGE model achieves:

* **Precision@10:** 0.02245
* **Recall@10:** 0.037705
* **NDCG@10:** 0.027998
* **Users evaluated:** 10,000

These results demonstrate that the model successfully captures collaborative structure using only user–movie interactions and movie genre features.

---

### Heterograph Model Performance

With the addition of semantic tag nodes and movie–tag relations, the heterograph model shows a consistent improvement across all ranking metrics:

* **Precision@10:** 0.02371
* **Recall@10:** 0.041555
* **NDCG@10:** 0.030635
* **Users evaluated:** 10,000

Compared to the bipartite baseline, the heterograph achieves:

* **+5.6% Precision@10**
* **+10.2% Recall@10**
* **+9.4% NDCG@10**

This validates that **injecting semantic knowledge (MovieLens Genome Tags)** enhances recommendation quality by providing richer contextual information to the model.
