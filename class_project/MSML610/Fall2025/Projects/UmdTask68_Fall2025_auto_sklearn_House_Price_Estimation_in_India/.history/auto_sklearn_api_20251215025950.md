...
This document explains the **native programming interface** used from auto-sklearn in `auto_sklearn_api.ipynb`, and how that relates to this project’s lightweight wrapper layer.
...
## Notebook walkthrough: `auto_sklearn_api.ipynb` (what each cell does)
...
(That end-to-end application is documented in `auto_sklearn_example.md`.)
