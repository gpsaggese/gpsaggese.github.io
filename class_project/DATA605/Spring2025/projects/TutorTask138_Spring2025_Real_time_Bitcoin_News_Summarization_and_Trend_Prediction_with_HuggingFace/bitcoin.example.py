...
# Real-time Bitcoin News Summarization & Sentiment Analysis (Example)

#This notebook demonstrates the end-to-end pipeline using real Bitcoin news fetched from NewsAPI, summarized via HuggingFace's BART model, and analyzed for sentiment using transformers. It uses utility functions from `bitcoin_utils.py`.
