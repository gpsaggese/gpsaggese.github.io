...
def plot_sales_bias_analysis(data: pd.DataFrame, marker: list) -> None:
    """
    ...
    :param marker: List of marker styles for plotting
    """
    plt.rc("font", size=20)
    plt.figure()
...
def plot_single_vs_separate_trends() -> None:
    """
...
def plot_simpsons_paradox() -> None:
    """
