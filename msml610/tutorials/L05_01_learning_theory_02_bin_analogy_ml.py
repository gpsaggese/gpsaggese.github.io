...
#
# - This visualization shows a bin filled with red and green marbles representing the unknown population
# - The parameter $\mu$ represents the true proportion of red marbles in the bin
...
#   - Does sample size $N$ matter? How much?
