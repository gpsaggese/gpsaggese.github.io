...
# # VC Dimension
#
# - This notebook uses interactive dichotomy explorers to make the growth
#   function and the VC dimension concrete, starting from the 2D perceptron
# - The pedagogical arc:
#   - Dichotomies of the 2D perceptron on 3 and 4 points, and its break point
#   - Growth functions of other hypothesis classes: positive rays, positive
#     intervals, and convex sets
