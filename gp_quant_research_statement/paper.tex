...
% ==============================================================================
  ...
  I am a quantitative researcher specializing in applying applying machine
  ...
  \begin{itemize}
    \item Contributed 25\% of profit and loss (PnL) to hedge funds managing
      \$1.6B in assets under management (AUM) across global futures and
      US equities
    ...
    \item Built and led research teams totaling 15+ quantitative researchers
      across two offices (Berkeley, CA and Moscow, Russia)
  \end{itemize}
...
% ------------------------------------------------------------------------------
  ...
  The equity fund went live around 2017. Realized performance is below.
